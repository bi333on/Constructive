...
## Возможности
- 15 стартовых блоков (обложка, преимущества, галерея, тарифы, FAQ, статистика, отзывы, команда, шаги, контакты и др.).
- Готовые шаблоны страниц (лендинг, портфолио, о компании).
...
- Авторизация (регистрация/вход), личные страницы каждого пользователя.
